...
from .views import HomeView, ThankYouView, ContactFormView, TeacherCreatView, TeacherListView, TeacherDetailView, TeacherUpdateView, TeacherDeleteView
...
urlpatterns = [
    ...
    path("create_teacher/", TeacherCreatView.as_view(), name="create_teacher"),
